...
const serviceID = 'service_259mgj8'
const tempID = 'template_ac9j3ac'
                  ...
                  <div className="modal-dialog">
                    <div className="modal-content">
                      ...
                      <div className="modal-footer">
                        ...
                        {showResendButton && (
                          <button type="button" className="btn btn-secondary" onClick={handleResendOtp}>Resend OTP</button>
                        )}
                      </div>
                    </div>
                  </div>
